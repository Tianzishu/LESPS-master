...
parser.add_argument("--model_names", default=['DCALNet'], nargs='+', help="model_name: 'ACM', 'ALCNet', 'DNANet'")
parser.add_argument("--pth_dirs", default=['Dataset-point/DCALNet_LESPS_coarse_530.pth.tar'],
                                            nargs='+', help="checkpoint dir, default=None")
parser.add_argument("--dataset_names", default=['Dataset-point'], nargs='+',
